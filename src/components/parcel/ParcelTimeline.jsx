// src/components/parcel/ParcelTimeline.jsx
import React from 'react';
import { PackageCheck, Truck, Bus, Navigation, Flag, Bike, CheckCircle, Clock, MapPin } from 'lucide-react';
...
const ParcelTimeline = ({ timeline }) => {
  ...
  const getStatusColor = (completed) => {
    return completed ? 'bg-gradient-to-r from-blue-500 to-cyan-500' : 'bg-gray-200';
  };
