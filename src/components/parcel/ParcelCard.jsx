...
import { 
  User, MapPin, Package, IndianRupee, Bus, 
  Calendar, Weight, Ruler, Tag, Phone, Mail
} from 'lucide-react';
        ...
        <div className="space-y-4">
          <div className="p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl">
            ...
            <div className="flex justify-between items-center">
              ...
              <span>{parcel.journey.busOperator}</span>
            </div>
          </div>
          ...
          <div className="p-4 bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-800 flex items-center gap-1">
                  <Ruler className="w-3 h-3" /> {parcel.parcel.dimensions}
                </p>
              </div>
              <div>
                <p className="text-xs text-gray-500">Value</p>
                <p className="font-semibold text-gray-800 flex items-center gap-1">
                  <Tag className="w-3 h-3" /> ₹{parcel.parcel.value}
                </p>
              </div>
            </div>
            {parcel.parcel.description && (
              <div className="mt-2 pt-2 border-t border-orange-200">
                <p className="text-xs text-gray-500">Description</p>
                <p className="text-sm text-gray-700">{parcel.parcel.description}</p>
              </div>
            )}
          </div>
        </div>
