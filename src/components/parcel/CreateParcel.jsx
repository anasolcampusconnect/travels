...
const CreateParcel = ({ onSuccess }) => {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
      {/* Header */}
      <div className="bg-gradient-to-r from-purple-600 via-pink-600 to-orange-500 px-6 py-5">
          ...
          {steps.map((s, idx) => (
            <div key={s.number} className="flex items-center flex-1">
              ...
              <div className="flex-1 h-1 mx-2 bg-gray-200 rounded">
                <div className={`h-full rounded transition-all duration-500 ${step > s.number ? 'w-full bg-gradient-to-r from-purple-600 to-pink-600' : 'w-0'}`} />
              </div>
            </div>
          ))}
        </div>
      ...
      <form onSubmit={handleSubmit} className="p-6">
          ...
          <div className="space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="relative group">
                <User className="absolute left-3 top-3 w-4 h-4 text-gray-400 group-focus-within:text-purple-500 transition-colors" />
              ...
              <div className="relative group">
                <Phone className="absolute left-3 top-3 w-4 h-4 text-gray-400 group-focus-within:text-purple-500" />
                <input type="tel" placeholder="Phone Number" required
                  className="w-full pl-10 pr-4 py-3 border-2 rounded-xl focus:outline-none focus:border-purple-500"
                  value={formData.sender.phone} onChange={(e) => handleInputChange('sender', 'phone', e.target.value)} />
              </div>
              <div className="relative group">
                <Mail className="absolute left-3 top-3 w-4 h-4 text-gray-400 group-focus-within:text-purple-500" />
                <input type="email" placeholder="Email Address"
                  className="w-full pl-10 pr-4 py-3 border-2 rounded-xl focus:outline-none focus:border-purple-500"
                  value={formData.sender.email} onChange={(e) => handleInputChange('sender', 'email', e.target.value)} />
              </div>
              <div className="relative group md:col-span-2">
                <MapPin className="absolute left-3 top-3 w-4 h-4 text-gray-400 group-focus-within:text-purple-500" />
          ...
          <div className="space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="relative group">
                ...
                <input type="text" placeholder="Full Name" required
                  className="w-full pl-10 pr-4 py-3 border-2 rounded-xl focus:outline-none focus:border-pink-500"
        ...
        {step === 3 && (
          <div className="space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <select className="w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:border-orange-500"
              ...
              <div className="relative group">
                ...
                <input type="number" step="0.1" placeholder="Weight (kg)" required
                  className="w-full pl-10 pr-4 py-3 border-2 rounded-xl focus:outline-none focus:border-orange-500"
              ...
              <textarea placeholder="Description (Optional)" rows="3"
                className="md:col-span-2 px-4 py-3 border-2 rounded-xl focus:outline-none focus:border-orange-500"
        ...
        {step === 4 && (
          <div className="space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <select className="w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:border-green-500" required
              ...
              <div className="relative group">
                <Bus className="absolute left-3 top-3 w-4 h-4 text-gray-400" />
              ...
              <div className="relative group">
                ...
                <select className="w-full pl-10 pr-4 py-3 border-2 rounded-xl focus:outline-none focus:border-green-500"
            ...
            {priceBreakdown && (
              <div className="mt-6 p-5 bg-gradient-to-r from-purple-50 via-pink-50 to-orange-50 rounded-2xl border border-purple-100">
                <h4 className="font-bold text-gray-800 mb-3 flex items-center gap-2">
                  <IndianRupee className="w-4 h-4 text-green-600" />
                  Price Breakdown
                </h4>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between"><span className="text-gray-600">Base Price:</span><span className="font-semibold">₹{priceBreakdown.basePrice}</span></div>
                  <div className="flex justify-between"><span className="text-gray-600">Distance Charge (₹0.5/km):</span><span>₹{priceBreakdown.distancePrice}</span></div>
                  <div className="flex justify-between"><span className="text-gray-600">Weight Charge (₹50/kg):</span><span>₹{priceBreakdown.weightPrice}</span></div>
                  <div className="border-t pt-2 mt-2"><div className="flex justify-between font-semibold"><span>Subtotal:</span><span>₹{priceBreakdown.subtotal}</span></div></div>
                  <div className="flex justify-between"><span className="text-gray-600">GST (18%):</span><span>₹{priceBreakdown.gst}</span></div>
                  <div className="border-t pt-2 mt-2"><div className="flex justify-between font-bold text-lg"><span>Total:</span><span className="text-green-600">₹{priceBreakdown.total}</span></div></div>
                </div>
              </div>
            )}
          </div>
        ...
        <div className="flex justify-between gap-3 mt-8 pt-4 border-t">
          ...
          {step < 4 ? (
            <button type="button" onClick={() => setStep(step + 1)}
              className="flex items-center gap-2 px-6 py-2.5 ml-auto bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-xl font-medium hover:shadow-lg transition-all">
