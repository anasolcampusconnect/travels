    ...
    <div className="animate-fadeIn space-y-6">
      ...
      <div className="flex flex-wrap justify-between items-center gap-4">
        <div>
          ...
          <p className="text-black/80 mt-1">Track and manage successfully delivered shipments</p>
        </div>
        <button className="flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur rounded-xl text-black hover:bg-white/20 transition-all">
