  ...
  return (
    <div className="animate-fadeIn space-y-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-black/80 text-lg">Welcome back! Here's what's happening with your shipments today.</p>
      </div>
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
  ...
  <div className="bg-gradient-to-r from-blue-400 to-cyan-400 rounded-2xl p-6 text-white">
    <div className="flex items-start justify-between">
      <div>
        ...
        <button className="px-4 py-2 bg-white text-blue-600 rounded-xl text-sm font-semibold hover:shadow-lg transition">
          Start Import →
        </button>
      </div>
  ...
  {/* Export Reports - Light Green */}
  <div className="bg-gradient-to-r from-green-400 to-emerald-400 rounded-2xl p-6 text-white">
    <div className="flex items-start justify-between">
      <div>
