    ...
    <div className="animate-fadeIn space-y-6">
      ...
      <div className="flex flex-wrap justify-between items-center gap-4">
        <div>
          ...
          <p className="text-black/80 mt-1">Track your earnings and financial performance</p>
        </div>
        <div className="flex gap-3">
          <select className="px-4 py-2 bg-white/10 backdrop-blur rounded-xl text-black border border-white/20">
